...
public class Krol extends Bierka {
    ...
    public List<Ruch> dajRuchCzarne(Szachownica sz) {
        ...
        if (this.getPole().getPozycjaX() + 1 < sz.getRozmiarSzachownicy() &&
                sz.getPlansza()[this.getPole().getPozycjaX() + 1][this.getPole().getPozycjaY()] != 5) {
            Ruch r = new Ruch();
            r.staraPozycja = this.getPole();
            r.nowaPozycja = new Pole(this.getPole().getPozycjaX() + 1, this.getPole().getPozycjaY());
            ruchy.add(r);
        }
        if (this.getPole().getPozycjaX() - 1 >= 0 &&
                sz.getPlansza()[this.getPole().getPozycjaX() - 1][this.getPole().getPozycjaY()] != 5) {
        ...
        if (this.getPole().getPozycjaY() + 1 < sz.getRozmiarSzachownicy() &&
                sz.getPlansza()[this.getPole().getPozycjaX()][this.getPole().getPozycjaY() + 1] != 5) {
            Ruch r = new Ruch();
            r.staraPozycja = this.getPole();
            r.nowaPozycja = new Pole(this.getPole().getPozycjaX(), this.getPole().getPozycjaY() + 1);
            ruchy.add(r);
        }
        if (this.getPole().getPozycjaY() - 1 >= 0 &&
                sz.getPlansza()[this.getPole().getPozycjaX()][this.getPole().getPozycjaY() - 1] != 5) {
            Ruch r = new Ruch();
            r.staraPozycja = this.getPole();
            r.nowaPozycja = new Pole(this.getPole().getPozycjaX(), this.getPole().getPozycjaY() - 1);
